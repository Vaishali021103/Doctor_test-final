          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <div className="mb-5 flex items-center justify-between">
              <label className="text-headingColor font-bold text-[16px] leading-7">
                Are you a:
                <select name="role" value={formData.role} onChange={handleInputChange} className="text-textColor fomt-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none">
              ...
              <label className="text-headingColor font-bold text-[16px] leading-7">
                Gender:
                <select name="gender" value={formData.gender} onChange={handleInputChange} className="text-textColor fomt-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none">
