          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <h3 className="text-headingColor text-[22px] leading-9 mt-3 font-bold">Prem Parmar</h3>
                <div className="flex items-center gap-[6px]">
                  <span className="flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
                    <img src={starIcon} alt="" className="w-4 h-4 lg:w-5 lg:h-5" />
                    4.8
                  </span>
                  <span className="text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400] text-textColor">
                   ...
                   <p className="text_para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">A surgeon is a doctor who specializes in evaluating and treating conditions that may require surgery, or physically changing the human body.</p>
              </div>
            </div>
